...
Widget NotificationTile(double height, double width,NotificationModel noti){
      ...
      Column(
        children: [
          SizedBox(
            ...
            child: Text(noti.message,style: TextStyle(fontFamily: Fonts.outfit,fontSize: 14))),
          SizedBox(
            width: width*0.85,
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Text("$day,",style: TextStyle(fontFamily: Fonts.nunito,fontSize: 10)),
                Text(date,style: TextStyle(fontFamily: Fonts.nunito,fontSize: 10))
              ],
            ),
          )
        ],
