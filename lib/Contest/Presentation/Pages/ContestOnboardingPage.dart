  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Test Information", style: TextStyle(color: Colors.black, fontFamily: Fonts.inter, fontSize: 16, fontWeight:   FontWeight.bold)),
          ...
          children: [
            ListView(
              ...
              children: [
                ...
                _headerSection(height, width, contest),
                SizedBox(height: 20),
                _statsSection(contest, width),
                SizedBox(height: 25),
                _aboutContest(),            
                SizedBox(height: 25),
                _instructions(width,height),
                // Instructions

                SizedBox(height: 25),
               _scoringSystem(contest),
                // Scoring System
...
Widget _headerSection(double height,double width, Contest contest){
  return    Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          contest.contestName,
                          style: TextStyle(fontFamily: Fonts.outfit, fontSize: 21, fontWeight: FontWeight.w600),
                        ),
                        SizedBox(height: 5),
                        Row(
                          children: [
                            Text("Subject :",style: TextStyle(fontFamily: Fonts.nunito, color: Colors.grey[600], fontSize: 12)),
                            SizedBox(width: 5),
                            Text(
                              contest.subject,
...
Widget _statsSection(Contest contest,double width){
  return Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
  ...
  Widget _aboutContest(){
    return Column(
      children: [
         Row(
                  children: [
                    Icon(Bootstrap.info_circle, color: Colors.green, size: 16, fontWeight: FontWeight.bold,),
                    SizedBox(width: 8),
                    Text("ABOUT CONTEST", style: TextStyle(fontFamily: Fonts.outfit, color: Colors.grey[700], fontSize: 12, fontWeight: FontWeight.w600)),
                  ],
                ),
                SizedBox(height: 10),
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontFamily: Fonts.nunito, color: Colors.black, height: 1.5, fontSize: 13),
                  ),
                ),
      ],
    );
  ...
  Widget _instructions(double width,double height){
    return Column(
      children: [
                  Row(
                  children: [
                    Icon(Bootstrap.file_earmark_text, color: Colors.green, size: 16, fontWeight: FontWeight.bold,),
                    SizedBox(width: 8),
                    Text("INSTRUCTIONS", style: TextStyle(fontFamily: Fonts.outfit, color: Colors.grey[700], fontSize: 12, fontWeight: FontWeight.w600)),
                  ],
                ),
                SizedBox(height: 10),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    _buildInstructionCard(width * 0.43, Bootstrap.clock, "Timer cannot be paused", Colors.green,height),
                    _buildInstructionCard(width * 0.43, Bootstrap.wifi, "Internet connection required", Colors.green,height),
                  ],
                ),
                SizedBox(height: 10),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    _buildInstructionCard(width * 0.43, Bootstrap.bullseye, "Negative marking active", Colors.green,height),
                    _buildInstructionCard(width * 0.43, Bootstrap.box_arrow_right, "Don't leave the screen", Colors.green,height),
                  ],
                ),
                SizedBox(height: 10),
                Container(
  ...
  Widget _buildInstructionCard(double width, IconData icon, String text, Color iconColor,double height) {
    return Container(
      width: width,
      height: height*0.1,
  ...
  Widget _scoringSystem(Contest contest){
    return Column(
      children: [
          Row(
                  children: [
                    Icon(Bootstrap.graph_up_arrow, color: Colors.green, size: 16,fontWeight: FontWeight.bold,),
                    SizedBox(width: 8),
                    Text("SCORING SYSTEM", style: TextStyle(fontFamily: Fonts.outfit, color: Colors.grey[700], fontSize: 12, fontWeight: FontWeight.w600)),
                  ],
                ),
                SizedBox(height: 10),
                Container(
